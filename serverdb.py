...
class ServerDB:
    ...
    def accept_student_sock(self):
        while True:
            ...
            student_socket.bind(("localhost", 9097))
    ...
    def recieve_id_pw(self, c_socket):
        ...
        connection = pymysql.connect(
            host='10.10.20.51', port=3306, user='root', password='1234',
        ...
        for sql_result_row in sql_result:
            ...
            if sql_result_row[2] == self.receive_student_id and \
                ...
                print("DB 내 선생 ID, PW 없음. 로그인 할 수 없음.")
        ...
        #     print("DB 내 선생 ID 있음. 로그인 절차 수행")
        #     if sql_result_row[3] == self.receive_student_pw:
        #         self.login_accept_msg = "@login_success@"
        #         print("DB 내 선생 PW 있음. 로그인 절차 수행")
        #         self.std_sock.send(self.login_accept_msg.encode())
        # else:
        #     self.login_accept_msg = "@login_fail@"
        #     print("DB 내 선생 PW 없음. 로그인 절차 수행 못함")
        #     self.std_sock.send(self.login_accept_msg.encode())
    ...
    #         th_msg = Thread(target=self.receive_message, args=(c_sock,))
    #         th_msg.start()
